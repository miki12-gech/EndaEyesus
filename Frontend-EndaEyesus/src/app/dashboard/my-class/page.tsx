...
export default function MyClassPage() {
    ...
    const serviceClass = user?.serviceClassName || "Fellowship Member";
    ...
    if (user?.status === "PENDING") {
        return (
            <div className="max-w-4xl mx-auto space-y-6">
                <Link
                    href="/dashboard"
                    className="inline-flex items-center gap-1.5 text-sm text-[#6b6b6b] dark:text-[#B0B0B0] hover:text-[#7A1C1C] dark:hover:text-[#D4AF37] font-medium transition-colors group"
                >
                ...
                <div className="bg-white dark:bg-[#1C1C1F] rounded-2xl p-8 border border-[#ddd8d0] dark:border-[#2a2a2d] text-center shadow-sm">
                    <div className="w-12 h-12 bg-[#7A1C1C]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                        <Users className="h-6 w-6 text-[#7A1C1C] dark:text-[#D4AF37]" />
                    </div>
                    ...
                    <p className="text-sm text-[#6b6b6b] dark:text-[#B0B0B0]">
                        You will be able to view your class details and members once an administrator approves your account.
                    </p>
                </div>
            </div>
        );
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-[#7A1C1C] dark:text-[#D4AF37]">{serviceClass}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 space-y-4">
                    <div className="bg-white dark:bg-[#1C1C1F] rounded-xl p-5 border border-[#ddd8d0] dark:border-[#2a2a2d] shadow-sm" style={{ borderLeft: "3px solid #7A1C1C" }}>
                        <h2 className="text-sm font-semibold text-[#7A1C1C] dark:text-[#D4AF37] flex items-center gap-2 mb-4">
                    ...
                    <div className="bg-white dark:bg-[#1C1C1F] rounded-xl p-5 border border-[#ddd8d0] dark:border-[#2a2a2d] shadow-sm" style={{ borderLeft: "3px solid #C9A227" }}>
                        <h2 className="text-sm font-semibold text-[#7A1C1C] dark:text-[#D4AF37] mb-3 flex items-center gap-2">
                        ...
                        <p className="text-xs text-[#6b6b6b] dark:text-[#B0B0B0] mt-1">
                            Weekly song: <span className="font-semibold text-[#7A1C1C] dark:text-[#D4AF37]">Siyume Egziabher</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="md:col-span-2 bg-white dark:bg-[#1C1C1F] rounded-xl p-5 border border-[#ddd8d0] dark:border-[#2a2a2d] shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-sm font-semibold text-[#7A1C1C] dark:text-[#D4AF37]">Class Members</h2>
                        <button className="text-xs text-[#C9A227] dark:text-[#D4AF37] font-semibold hover:text-[#7A1C1C] dark:hover:text-[#F5F5F5] flex items-center gap-0.5 transition-colors">
                    ...
                    <div className="space-y-3">
                        {classMembers.map((m) => (
                            <div key={m.name} className="flex items-center gap-4 p-3 rounded-xl hover:bg-[#F8F5F0] dark:hover:bg-[#252529] transition-colors">
                                <div className="w-10 h-10 rounded-full bg-[#7A1C1C] dark:bg-[#9B2323] text-[#C9A227] dark:text-[#D4AF37] flex items-center justify-center text-sm font-bold flex-shrink-0">
                                    {m.initials}
                                </div>
                                <div>
